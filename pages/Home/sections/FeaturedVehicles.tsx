      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {MOCK_VEHICLES.map((vehicle) => (
            <div key={vehicle.id} className={`bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow ${vehicle.isPopular ? 'border-2 border-primary/20' : ''}`}>
              <div 
