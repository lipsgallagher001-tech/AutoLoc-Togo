  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      if (currentHash.includes('#') && !currentHash.startsWith('#/')) {
        ...
        // Scroll fluide vers le haut lors du changement de page
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="fixed bottom-24 right-6 z-[60]">
        <button className="group size-14 bg-primary text-white rounded-full flex items-center justify-center shadow-2xl shadow-primary/50 transition-transform hover:scale-110">
          <span className="material-symbols-outlined text-3xl">chat</span>
          <span className="absolute right-full mr-4 bg-white dark:bg-slate-800 text-[#111418] dark:text-white px-4 py-2 rounded-lg text-sm font-bold shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-[#f0f2f4] dark:border-slate-700">
